            ...
            if constexpr (
                ...
                if (input_tensor_a.memory_config().is_sharded()) {
                    ...
                    if (tensor_a_memory_layout == TensorMemoryLayout::BLOCK_SHARDED) {
                        ...
                        // std::cout << "K: " << K << " shard_shape[1]: " << shard_shape[1] << " (K / (shard_shape[1] / TILE_WIDTH)): " << K / (shard_shape[1] / TILE_WIDTH) <<std::endl;
                        // std::cout << "N: " << N << " per_core_N: " << program_config.per_core_N << " div_up(N, program_config.per_core_N): " << div_up(N, program_config.per_core_N) <<std::endl;
