...
class geglu:
    ...
    def __call__(self, config, hidden_states):
        ...
        proj = ttl.operations.primary.matmul(
            hidden_states,
        ...
        proj = ttl.tensor.interleaved_to_sharded(
            proj,
            grid_size,
        ...
        program_config = ttl.operations.primary.MatmulMultiCoreReuseMultiCastProgramConfig(
            ...
            per_core_M=M // grid_size[0] // 32,
            per_core_N=per_core_N,
            fused_activation=[ttl.tensor.FusibleActivation.GELU, False],
            transpose_mcast=True,
        )
        gate = ttl.operations.primary.matmul(
            hidden_states,
        ...
        gate = ttl.tensor.interleaved_to_sharded(
            gate,
            grid_size,
